...
const AllProduct = () => {
    ...
    const [seeFilter, setSeeFilter] = useState(true);
    const [seeDropDownMenu, setSeeDropDownMenu] = useState(false);
    const handleFilterMenu = () => {
        setSeeFilter(!seeFilter);
        setSeeDropDownMenu(!seeDropDownMenu);
    }
    ...
    const filterLowToHigh = () => {
        setSeeDropDownMenu(!seeDropDownMenu);
        setSeeFilter(!seeFilter);
        const sortedData = [...data].sort((a, b) => a.price2 - b.price2);
        setData(sortedData);
    }

    const filterHightToLow = () => {
        setSeeDropDownMenu(!seeDropDownMenu);
        setSeeFilter(!seeFilter);
        const sortedData = [...data].sort((a, b) => a.price2 - b.price2).reverse();
        setData(sortedData);
    }
        ...
        <>
            <div className={`${styles['container']}`}>
                ...
                <div className={styles.filterContainer}>
                    ...
                    >Filter
                        <RiArrowDropDownLine
                            className={`${styles['dropdownIcon']} ${seeFilter ? styles.iconUp : styles.iconDown}`} />
                    </h1>
                    <div className={`${styles['dropDownMenuSection']} ${seeDropDownMenu ? styles.dropDownMenuOpen : styles.dropDownMenuClose}`}>
                        <div
